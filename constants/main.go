...
const TCPSynHeaderPartSize = 20

var TCPSynHeaderPart = [TCPSynHeaderPartSize]byte{
...
const TCPSynVavHeaderPartSize = 24

// TCPSynVavHeaderPart is the TCP header for SYN/VAV scanning.
...
var TCPSynVavHeaderPart = [TCPSynVavHeaderPartSize]byte{
...
const ArcornSize = 147

// Arcorn Hex interpretation of the ASCII art of the Arcorn logo
// vaverka  _
//
//	    _/-\_
//	 .-`-:-:-`-.
...
const UDPHeaderPartSize = 15

// UdpPart is a 15-byte UDP datagram part consisting of the UDP header and payload "vaverka".
...
var UdpPart = [UDPHeaderPartSize]byte{
	// [0:1] UDP Source Port
	0x00, 0x00,
